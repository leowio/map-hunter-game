...
(function (modules) {
      ...
      return (
        (a.prototype.set = function (t, e, n) {
          ...
          t: for (var i in t) {
            ...
            var c = r[i];
            this.isUndef(c) ||
              ((a.Signal && c instanceof a.Signal) || (a.Param && c instanceof a.Param)
        ...
        (a.prototype.isObject = function (t) {
          return (
            "[object Object]" === Object.prototype.toString.call(t) && t.constructor === Object
          );
        }),
        ...
        window.TONE_SILENCE_VERSION_LOGGING ||
          console.log("%c * Tone.js " + a.version + " * ", "background: #000; color: #fff"),
        a
      );
          ...
          ((this._shaper = this.input = this.output = this.context.createWaveShaper()),
            ...
            Array.isArray(e)
              ...
              : isFinite(e) || this.isUndef(e)
                ...
                : this.isFunction(e) &&
                  ((this._curve = new Float32Array(this.defaultArg(t, 1024))), this.setMap(e)));
        }),
      ...
      return (
        ...
        (o.TimelineSignal.prototype.setValueAtTime = function (e, t) {
          return (
            (e = this._fromUnits(e)),
            (t = this.toSeconds(t)),
            this._events.add({ type: o.TimelineSignal.Type.Set, value: e, time: t }),
        ...
        (o.TimelineSignal.prototype.linearRampToValueAtTime = function (e, t) {
          return (
            (e = this._fromUnits(e)),
            (t = this.toSeconds(t)),
            this._events.add({ type: o.TimelineSignal.Type.Linear, value: e, time: t }),
        ...
        (o.TimelineSignal.prototype.exponentialRampToValueAtTime = function (e, t) {
          ...
          return (
            this._events.add({ type: o.TimelineSignal.Type.Exponential, value: n, time: t }),
            e < this._minOutput
              ? (this._param.exponentialRampToValueAtTime(this._minOutput, t - this.sampleTime),
        ...
        (o.TimelineSignal.prototype.setValueCurveAtTime = function (e, t, i, n) {
          ...
          ((t = this.toSeconds(t)),
            (i = this.toSeconds(i)),
            this._events.add({ type: o.TimelineSignal.Type.Curve, value: a, time: t, duration: i }),
        ...
        (o.TimelineSignal.prototype.getValueAtTime = function (e) {
          ...
          if (null === i) n = this._initial;
            ...
            ((a = null === l ? this._initial : l.value),
              (n = this._exponentialApproach(i.time, a, i.value, i.constant, e)));
          } else
            n =
                ...
                : null === t
                  ...
                  : t.type === o.TimelineSignal.Type.Linear
                    ...
                    : t.type === o.TimelineSignal.Type.Exponential
                      ? this._exponentialInterpolate(i.time, i.value, t.time, t.value, e)
                      : i.value;
          return n;
        }),
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (i) {
      ...
      return (
        ...
        (i.prototype.createInsOuts = function (t, n) {
          (1 === t ? (this.input = new i.Gain()) : 1 < t && (this.input = new Array(t)),
            1 === n ? (this.output = new i.Gain()) : 1 < n && (this.output = new Array(t)));
        }),
        i.Gain
      );
    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)),
      ...
      return (
        (o.Clock = function () {
          ...
          ((this.callback = t.callback),
            ...
            (this.frequency = new o.TimelineSignal(t.frequency, o.Type.Frequency)),
            ...
            AudioNode.prototype.connect !== t &&
              ...
              (AudioNode.prototype.disconnect = function (e, t, n) {
                if (e && e.input && Array.isArray(e.input))
                  (o.prototype.isUndef(n) && (n = 0), this.disconnect(e.input[n], t, n));
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (n) {
      return (
        ...
        (n.TimeBase.prototype._primaryExpressions = {
          ...
          tr: {
            ...
            method: function (e, t, r) {
              var n = 0;
              return (
                e && "0" !== e && (n += this._beatsToUnits(this._timeSignature() * parseFloat(e))),
        ...
        (n.TimeBase.prototype._parseBinary = function (e, t) {
          ...
          for (var n = e.peek(); n && this._matchGroup(n, this._binaryExpressions, t); )
            ((r = (n = e.next()).method.bind(this, r, this._parseBinary(e, t - 1))),
              (n = e.peek()));
          return r;
        }),
        (n.TimeBase.prototype._parseUnary = function (e) {
          ...
          return n
            ? ((t = e.next()), (r = this._parseUnary(e)), n.method.bind(this, r))
        ...
        (n.TimeBase.prototype._pushExpr = function (e, t, r) {
          return (
            ...
            (this._expr = this._binaryExpressions[t].method.bind(this, this._expr, e._expr)),
            this
          );
        }),
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (t) {
      ...
      return (
        ...
        (t.Negate.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this), this._multiply.dispose(), (this._multiply = null), this
          );
        }),
        t.Negate
      );
      ...
      return (
        (i.CrossFade = function (e) {
          (this.createInsOuts(2, 1),
            ...
            (this.fade = new i.Signal(this.defaultArg(e, 0.5), i.Type.NormalRange)),
        ...
        (p.Expr.prototype._parseTree = function (e) {
          ...
          function i(e) {
            ...
            for (var r = t.peek(); o(r, "binary", e); )
              ((n = { operator: (r = t.next()).value, method: r.method, args: [n, i(e - 1)] }),
                (r = t.peek()));
            return n;
          }
          function s() {
    ...
    (__WEBPACK_AMD_DEFINE_RESULT__ = function (e) {
      ...
      return (
        ...
        (e.EqualPowerGain.prototype.dispose = function () {
          return (
            e.prototype.dispose.call(this), this._eqPower.dispose(), (this._eqPower = null), this
          );
        }),
        e.EqualPowerGain
      );
  ...
  function (module, __webpack_exports__, __webpack_require__) {
        ...
        },
        {
          ...
          value: function play(startTime, rate, amp, _cueStart, duration) {
            ...
            if (this.buffer) {
              ...
              if (duration) {
                duration =
                  duration <= this.buffer.duration - cueStart ? duration : this.buffer.duration;
              }
    ...
    p5.Envelope.prototype.setADSR = function (aTime, dTime, sPercent, rTime) {
      ...
      this.dLevel =
        typeof sPercent !== "undefined" ? sPercent * (this.aLevel - this.rLevel) + this.rLevel : 0;
      this.rTime = rTime || 0;
    ...
    var pulse_Pulse = (function (_Oscillator) {
      ...
      function Pulse(freq, w) {
        ...
        _this = pulse_possibleConstructorReturn(
          this,
          pulse_getPrototypeOf(Pulse).call(this, freq, "sawtooth"),
        );
    ...
    var HighPass = (function (_Filter2) {
      ...
      function HighPass() {
        ...
        return filter_possibleConstructorReturn(
          this,
          filter_getPrototypeOf(HighPass).call(this, "highpass"),
        );
      }
    ...
    var BandPass = (function (_Filter3) {
      ...
      function BandPass() {
        ...
        return filter_possibleConstructorReturn(
          this,
          filter_getPrototypeOf(BandPass).call(this, "bandpass"),
        );
      }
    ...
    var eqFilter_EQFilter = (function (_Filter) {
      ...
      function EQFilter(freq, res) {
        ...
        _this = eqFilter_possibleConstructorReturn(
          this,
          eqFilter_getPrototypeOf(EQFilter).call(this, "peaking"),
        );
    ...
    var Compressor = (function (_Effect) {
      ...
      compressor_createClass(Compressor, [
        ...
        },
        {
          key: "dispose",
          value: function dispose() {
            compressor_get(compressor_getPrototypeOf(Compressor.prototype), "dispose", this).call(
              this,
            );
    ...
    var Distortion = (function (_Effect) {
      ...
      distortion_createClass(Distortion, [
        ...
        },
        {
          key: "dispose",
          value: function dispose() {
            distortion_get(distortion_getPrototypeOf(Distortion.prototype), "dispose", this).call(
              this,
            );
    ...
    var monosynth_MonoSynth = (function (_AudioVoice) {
      ...
      monosynth_createClass(MonoSynth, [
        ...
        },
        {
          key: "dispose",
          value: function dispose() {
            monosynth_get(monosynth_getPrototypeOf(MonoSynth.prototype), "dispose", this).call(
              this,
            );
