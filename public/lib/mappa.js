            ...
            [
              ...
              },
              {
                ...
                value: function latLngToPixel(lat, lng) {
                  return {
                    x:
                      this.fromLngToPoint(lng) -
                      this.fromLngToPoint(this.options.lng) +
                      this.options.width / (2 / this.options.scale),
                    y:
                      this.fromLatToPoint(lat) -
                      this.fromLatToPoint(this.options.lat) +
                      this.options.height / (2 / this.options.scale),
                  };
                },
              },
              {
                ...
                value: function fromLatToPoint(l) {
                  return (
                    (this.options.pixels / Math.PI) *
                    Math.pow(2, this.options.zoom) *
                    (Math.PI - Math.log(Math.tan(Math.PI / 4 + (l * Math.PI) / 180 / 2)))
                  );
                },
              },
              {
            ...
            [
              {
                ...
                value: function geoJSON() {
                  return (0, _parseGeoJSON2.default)(
        ...
        var Leaflet = (function (_TileMap) {
          ...
          function Leaflet(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Leaflet.__proto__ || Object.getPrototypeOf(Leaflet)).call(this, options),
            );
                  ...
                  this.map.on("move", function () {
                    ...
                    if (d._newPos) {
                      cnvs.canvas.style.transform =
                        "translate(" + -d._newPos.x + "px, " + -d._newPos.y + "px)";
                    }
                  });
                },
              },
                ...
                value: function messages() {
                  return {
                    tiles: function tiles() {
                      console.warn(
                        "You are not using any tiles for your map. Try with: http://{s}.tile.osm.org/{z}/" +
                          "{x}/{y}.png",
                      );
                    },
                  };
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var eachFeature = function eachFeature(feature, type) {
          if (feature.hasOwnProperty("geometry") && feature.geometry.type === type) {
            ...
            feature.hasOwnProperty("geometries") &&
            feature.geometries instanceof Array &&
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Google = (function (_StaticMap) {
          ...
          function Google(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Google.__proto__ || Object.getPrototypeOf(Google)).call(this, options),
            );
              ...
              },
              {
                ...
                value: function messages() {
                  return {
                    ...
                    key: function key() {
                      console.warn(
                        "For better results please provide an API key for your Google Maps Static API.",
                      );
                    },
                  };
                },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Mapbox = (function (_StaticMap) {
          ...
          function Mapbox(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Mapbox.__proto__ || Object.getPrototypeOf(Mapbox)).call(this, options),
            );
                    ...
                    size: function size(s, m) {
                      return console.warn(
                        "You requested an image with a " +
                          ...
                          " of " +
                          m +
                          "px. Mapbox Static API max " +
                          s +
                          " value is 1280px. If you want a large image change the scale to 2.",
                      );
                    },
                    key: function key() {
                      console.error(
                        "Mapbox Static API needs a key to work. To get a key visit: https://www.mapbox.com/api-documentation/#static",
                      );
                    },
                  };
                },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Mapquest = (function (_StaticMap) {
          ...
          function Mapquest(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Mapquest.__proto__ || Object.getPrototypeOf(Mapquest)).call(this, options),
            );
              ...
              },
              {
                ...
                value: function messages() {
                  return {
                    ...
                    key: function key() {
                      console.warn(
                        "Please provide and API key to work with Mapquest Static API. Get one here: https://developer.mapquest.com/documentation/",
                      );
                    },
                  };
                },
            ...
            [
              {
                ...
                value: function createMap() {
                  ...
                  google.maps.event.addListener(this.map, "bounds_changed", function () {
                    var center = overlay
                      .getProjection()
                      .fromLatLngToDivPixel(_this2.map.getCenter());
                    var pixels = 2;
              ...
              },
              {
                ...
                value: function onChange(callback) {
                  ...
                  if (this.ready) {
                    callback();
                    this.onChangeMethods[callback] = google.maps.event.addListener(
                      this.map,
                      "bounds_changed",
                      callback,
                    );
            ...
            [
              {
                ...
                value: function messages() {
                  return {
                    key: function key() {
                      console.warn(
                        "Please provide a Goolge Maps API Key. Get one here: https://developers.google.com/maps/documentation/javascript/ ",
                      );
                    },
                  };
                },
            ...
            [
              {
                ...
                value: function createMap() {
                  ...
                  if (this.options.studio) {
                    this.tiles = L.mapbox
                      .styleLayer(this.options.style || "mapbox://styles/mapbox/emerald-v8")
                      .addTo(this.map);
                  } else {
                    this.tiles = L.mapbox
                      .tileLayer(this.options.style || "mapbox.streets")
                      .addTo(this.map);
                  }
            ...
            [
              {
                ...
                value: function messages() {
                  return {
                    key: function key() {
                      console.warn(
                        "Please provide a Mapbox API key. Get one here: https://www.mapbox.com/mapbox.js/api/v3.1.1",
                      );
                    },
                  };
                },
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var MapboxGL = (function (_TileMap) {
          ...
          function MapboxGL(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (MapboxGL.__proto__ || Object.getPrototypeOf(MapboxGL)).call(this, options),
            );
            ...
            [
              {
                ...
                value: function createMap() {
                  ...
                  if (this.options.opacity) {
                    document.getElementsByClassName("mapboxgl-canvas")[0].style.opacity =
            ...
            [
              {
                ...
                value: function messages() {
                  return {
                    key: function key() {
                      console.warn(
                        "Please provide a Mapbox-gl API key. Get one here: https://www.mapbox.com/mapbox-gl-js/api/",
                      );
                    },
                  };
                },
